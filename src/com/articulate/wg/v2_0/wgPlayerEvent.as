package com.articulate.wg.v2_0
{
	...
	{
		/**
		 * The <i>SLIDE_UPDATE_TIMELINE</i> constant defines the value of the <i>type</i> property of the
		 * event that is dispatched when the timeline is changed.
		 */
		public static const SLIDE_UPDATE_TIMELINE:String = "bw_slide_update_timeline";
		/**
