package com.articulate.wg.v2_0
{
	...
	public class wgEventFrame extends Event
	{
		...
		/**
		 * The <i>GET_SLID</i> constant defines the value of the <i>type</i> property of an event that
		 ...
		 * @param scrubtime <i>Deprecated:</i>The playback time in milliseconds. <i>This is not used in the current Articulate player.</i>
		...
		/**
		 * <i>Deprecated:</i>The current timeline value in milliseconds. <i>This is not used in the current Articulate player.</i>
		 */
